    ...
    <div class="container-fluid">
      ...
      <div class="panel panel-default card-view">
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													...
													<form class="form-horizontal" method="POST" action="{{ route('pupuk.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group">
															...
															<div class="col-sm-9">
                                  <div class="mt-40">
                											<input type="file" id="input-file-max-fs" name="gambar" class="dropify" data-max-file-size="2M" />
                									</div>
															</div>
														</div>
